...
void CGUISettings::Initialize()
{
 ...
 // AddInt(1, "videoplayer.resumeautomatically", 12017, RESUME_ASK, RESUME_NO, 1, RESUME_ASK, SPIN_CONTROL_TEXT);
  ...
  // appearance settings
	...
	AddString(2, "lookandfeel.skintheme",15111,"SIMPLE", SPIN_CONTROL_TEXT);
	AddString(3, "lookandfeel.skincolors",14078, "SIMPLE", SPIN_CONTROL_TEXT);
	...
	AddString(7, "lookandfeel.soundskin",15108,"SIMPLE", SPIN_CONTROL_TEXT);
