...
void CGUIWindowSettingsCategory::OnSettingChanged(CBaseSettingControl *pSettingControl)
{
  ...
  { // new skin choosen...
    ...
    CStdString strSkinPath = "Q:\\" + strSkin;
...
void CGUIWindowSettingsCategory::FillInSoundSkins(CSetting *pSetting)
{
  ...
  //find skins...
  CFileItemList items;
  CDirectory::GetDirectory("special://xbmc/default skin/sounds/", items);
  if (!CSpecialProtocol::XBMCIsHome())
    CDirectory::GetDirectory("special://home/default skin/sounds/", items);
