...
if exist "..\Other\build for release" (
	Call Other\Tools\repl.bat "XBMC-Emustation 0.0.000" "XBMC-Emustation Test Build 1.1.%daytotal%" L < "%foldername%\default skin\language\English\strings.po" >"%foldername%\default skin\language\English\strings.tmp"
...
"C:\Program Files\7-Zip\7z.exe" a "..\XBMC-Emustation-test-build.zip" "..\Other\update build\*" -mx=7 -r -y
