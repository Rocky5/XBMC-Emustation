...
Call Other\Tools\repl.bat "xbmc-emustation 0.0.000" "xbmc-emustation test build %version%.%daytotal%" L < "%foldername%\emustation\themes\simple\language\English\strings.po" >"%foldername%\emustation\themes\simple\language\English\strings.tmp"
