...
DidntXSpectrum FUSE Spectrum Emulator port for XBox v3
...
DidntXSpectrum FUSE Spectrum Emulator port for XBox v2
...
****************************
 ...
 - Added option to enable/disable tape loading sounds


Notes
-----

If your keyboard is not acting the way you want, make sure that all
the joystick configuration options are turned off.


------------------------------------------------------------------------

DidntXSpectrum FUSE Spectrum Emulator port for XBox v1
...
Features :
 ...
 - Emulates the Spectrum 16/48/128/Plus2/Plus2a/Plus3/Plus3e/TC2048/
                         TC2068/TS2068/Pentagon/Scorpion/SE

 - Excellent compatibility - ported from FUSE

Put games in the \SPECGAMES directory
...
*****************************
 ...
 - All the other standard XPort features
